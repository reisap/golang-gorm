...
type ICampaignImageDo interface {
	...
	Create(values ...*model.CampaignImage) error
	CreateInBatches(values []*model.CampaignImage, batchSize int) error
	Save(values ...*model.CampaignImage) error
	First() (*model.CampaignImage, error)
	Take() (*model.CampaignImage, error)
	Last() (*model.CampaignImage, error)
	Find() ([]*model.CampaignImage, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.CampaignImage, err error)
	FindInBatches(result *[]*model.CampaignImage, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.CampaignImage) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.CampaignImage, error)
	FirstOrCreate() (*model.CampaignImage, error)
	FindByPage(offset int, limit int) (result []*model.CampaignImage, count int64, err error)
